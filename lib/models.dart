...
// ═══════════════════════════════════════════════════════════════
// 1. LLM & MCP Configuration Models
// ═══════════════════════════════════════════════════════════════
...
class MCPContent {
  final String type;
  final String? text;
  final String? data; // Base64 representation
...
class MessageAttachment {
  ...
  final String name;
  final String path;
  final Uint8List? bytes; // Supports Web/memory storage
  final String mimeType;
  final int? size;
...
class ChatMessage {
  ...
  factory ChatMessage.fromJson(Map<String, dynamic> json) {
    return ChatMessage(
      ...
      role: ChatRole.values.firstWhere((r) => r.name == json['role'], orElse: () => ChatRole.user),
